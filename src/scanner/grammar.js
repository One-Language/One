...
var grammar = {
    Lexer: undefined,
    ParserRules: [
    {"name": "program", "symbols": ["functions"], "postprocess": 
        data => {
        	return {
        		"functions": data[0],
        	}
    ...
    {"name": "args", "symbols": [{"literal":"("}, "expressions", {"literal":")"}], "postprocess": 
        data=> {
        	return data[1]
        }
        	},
    {"name": "args", "symbols": [{"literal":"("}, {"literal":")"}], "postprocess": 
        data=> {
        	return []
        }
        	},
    {"name": "data_type$string$1", "symbols": [{"literal":"i"}, {"literal":"n"}, {"literal":"t"}, {"literal":"8"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "data_type", "symbols": ["data_type$string$1"], "postprocess": id},
    {"name": "data_type$string$2", "symbols": [{"literal":"i"}, {"literal":"n"}, {"literal":"t"}, {"literal":"1"}, {"literal":"6"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "data_type", "symbols": ["data_type$string$2"], "postprocess": id},
    {"name": "data_type$string$3", "symbols": [{"literal":"i"}, {"literal":"n"}, {"literal":"t"}, {"literal":"3"}, {"literal":"2"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "data_type", "symbols": ["data_type$string$3"], "postprocess": id},
    {"name": "data_type$string$4", "symbols": [{"literal":"i"}, {"literal":"n"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "data_type", "symbols": ["data_type$string$4"], "postprocess": id},
    {"name": "data_type$string$5", "symbols": [{"literal":"i"}, {"literal":"n"}, {"literal":"t"}, {"literal":"6"}, {"literal":"4"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "data_type", "symbols": ["data_type$string$5"], "postprocess": id},
    {"name": "data_type$string$6", "symbols": [{"literal":"u"}, {"literal":"i"}, {"literal":"n"}, {"literal":"t"}, {"literal":"8"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "data_type", "symbols": ["data_type$string$6"], "postprocess": id},
    {"name": "data_type$string$7", "symbols": [{"literal":"u"}, {"literal":"i"}, {"literal":"n"}, {"literal":"t"}, {"literal":"1"}, {"literal":"6"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "data_type", "symbols": ["data_type$string$7"], "postprocess": id},
    {"name": "data_type$string$8", "symbols": [{"literal":"u"}, {"literal":"i"}, {"literal":"n"}, {"literal":"t"}, {"literal":"3"}, {"literal":"2"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "data_type", "symbols": ["data_type$string$8"], "postprocess": id},
    {"name": "data_type$string$9", "symbols": [{"literal":"u"}, {"literal":"i"}, {"literal":"n"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "data_type", "symbols": ["data_type$string$9"], "postprocess": id},
    {"name": "data_type$string$10", "symbols": [{"literal":"u"}, {"literal":"i"}, {"literal":"n"}, {"literal":"t"}, {"literal":"6"}, {"literal":"4"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "data_type", "symbols": ["data_type$string$10"], "postprocess": id},
    {"name": "data_type$string$11", "symbols": [{"literal":"b"}, {"literal":"o"}, {"literal":"o"}, {"literal":"l"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "data_type", "symbols": ["data_type$string$11"], "postprocess": id},
    {"name": "data_type$string$12", "symbols": [{"literal":"s"}, {"literal":"t"}, {"literal":"r"}, {"literal":"i"}, {"literal":"n"}, {"literal":"g"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "data_type", "symbols": ["data_type$string$12"], "postprocess": id},
    {"name": "data_type$string$13", "symbols": [{"literal":"c"}, {"literal":"h"}, {"literal":"a"}, {"literal":"r"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "data_type", "symbols": ["data_type$string$13"], "postprocess": id},
    {"name": "expressions", "symbols": ["___", "expression", "___"], "postprocess": 
        data => [data[1]]
        	},
    {"name": "expressions", "symbols": ["___", "expression", "___", {"literal":","}, "expressions"], "postprocess": 
        data => [data[1], ...data[4]]
        	},
    {"name": "functions", "symbols": ["___", "function", "___"], "postprocess": 
        data => [data[1]]
        	},
    {"name": "functions", "symbols": ["___", "function", "___", {"literal":"\n"}, "functions"], "postprocess": 
        data => [data[1], ...data[4]]
        	},
    {"name": "function", "symbols": ["identifier", "___", "args", "___", "block_statements"], "postprocess": 
        data => {
        	return {
        		type: "function",
        		"return": "int32",
    ...
    {"name": "function", "symbols": ["data_type", "___", "identifier", "___", "args", "___", "block_statements"], "postprocess": 
        data => {
        	return {
        		type: "function",
        		"return": data[0],
    ...
    {"name": "function", "symbols": ["data_type", "___", "identifier", "___", "block_statements"], "postprocess": 
        data => {
        	return {
        		type: "function",
        		return: data[0],
    ...
    {"name": "function", "symbols": ["identifier", "___", "block_statements"], "postprocess": 
        data => {
        	return {
        		type: "function",
        		"return": "int32",
    ...
    {"name": "block_statements", "symbols": [{"literal":"{"}, "statements", {"literal":"}"}], "postprocess": 
        data => {
        	return data[1]
        }
        	},
    {"name": "block_statements", "symbols": [{"literal":"{"}, "___", {"literal":"}"}], "postprocess": 
        data => {
        	return []
        }
        	},
    {"name": "statements", "symbols": ["___", "statement", "___"], "postprocess": 
        data => [data[1]]
        },
    {"name": "statements", "symbols": ["___", "statement", "___", {"literal":"\n"}, "statements"], "postprocess": 
        data => [data[1], ...data[4]]
        	},
