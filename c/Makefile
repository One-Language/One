...
out/buffer/sds.o: src/buffer/sds.c src/buffer/sds.h src/buffer/sdsalloc.h src/buffer/testhelp.h
	gcc -c src/buffer/sds.c -o out/buffer/sds.o -Wall -Wextra
...
out/one.o: out/buffer/sds.o src/one.c out/io.o out/lexer/token.o out/lexer/source.o out/lexer/lexer.o 
	gcc \
		src/one.c \
		out/io.o \
		out/buffer/sds.o \
