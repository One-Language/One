...
<p>
    <a href="https://onelang.org/" alt="The One لغة ">
...
- لا يتطلب منك مكتبات وأدوات محددة على نظام المستخدم في الوضع العادي (في
  المستقبل)
...
الرجوع الى [هذا الرابط](https://github.com/ET-Lang/ET/wiki) لبدء تعلم أساسيات
اللغة.
...
الوثائق وما إلى ذلك. لطرح سؤال أو فتح مناقشة أو إنشاء مشكلة , نرجو الإنضمام إلى
سيرفر الدسكورد الخاص بنا . <a href ="https://discord.gg/sFCE2HcMCa"><b>One</b>
Discord Server</a>.

إذا لم تكن على دراية بكيفية تقديم طلب تعديل على GitHub ، فيرجى قراءة هذا .
