...
void main_help(void) {
  print("One is a programming language and its here to manage your One "
        "programs.\n"
        "\n"
        "Usage:\n"
        "\n"
...
void main_build(int argc, char *argv[]) {
  ...
  if (data == NULL) {
    error("We cannot read your input file, probably it's not available or it's "
          "OS-permission problem!\n");
    return;
  }
...
void main_run(int argc, char *argv[]) { main_build(argc, argv); }
